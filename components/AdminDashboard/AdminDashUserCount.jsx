...
const AdminDashUserCount = () => {
  ...
  return (
    <div className="text-black dark:text-white shadow bg-white dark:bg-tertiary p-4 w-full rounded  mt-4">
      ...
      <p className='bg-[#6c52ff] p-2 rounded-md font-semibold'>Admin : {totalTraderAccounts}</p>
      <p className='bg-[#5dad3e] p-2 rounded-md font-semibold'>Trader : {totalAdminAccounts }</p>
      </div>
    </div>
  );
};
