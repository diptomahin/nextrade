...
const Drawer = ({ toggleMenu }) => {
  ...
  return (
    <div
      className={`xl:hidden fixed top-0 left-0 h-screen w-9/12 sm:w-1/2 md:w-2/5 bg-white transition-transform transform duration-500 ease-in-out z-50 border-r-2 ${toggleMenu ? "translate-x-0" : "-translate-x-full"
        }`}
    >
