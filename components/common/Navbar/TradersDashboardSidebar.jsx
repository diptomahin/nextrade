  ...
  const dashboardUpperLinkForUser = [
    {
      route: "Dashboard",
      pathname: "/dashboard",
      icon: <GridViewIcon sx={{ borderRadius: "50px", backgroundColor: "white", color: "#21366c", marginRight: "14px", width: "35px", height: "35px", padding: "8px" }} />
    },
    {
      route: "Portfolio",
      pathname: "/dashboard/portfolio",
      icon: <ShowChartIcon sx={{ borderRadius: "50px", backgroundColor: "white", color: "#21366c", marginRight: "14px", width: "35px", height: "35px", padding: "8px" }} />
    },
    {
      route: "Trading",
      pathname: "/dashboard/trading",
      icon: <TollIcon sx={{ borderRadius: "50px", backgroundColor: "white", color: "#21366c", marginRight: "14px", width: "35px", height: "35px", padding: "8px" }} />
    },
    {
      route: "Watchlist",
      pathname: "/dashboard/watchlist",
      icon: <VisibilityOutlinedIcon sx={{ borderRadius: "50px", backgroundColor: "white", color: "#21366c", marginRight: "14px", width: "35px", height: "35px", padding: "8px" }} />
    },
    {
      route: "Academy",
      pathname: "/dashboard/academy",
      icon: <MenuBookOutlinedIcon sx={{ borderRadius: "50px", backgroundColor: "white", color: "#21366c", marginRight: "14px", width: "35px", height: "35px", padding: "8px" }} />
    },
    {
      route: "Profile",
      pathname: "/dashboard/profile",
      icon: <PersonOutlinedIcon sx={{ borderRadius: "50px", backgroundColor: "white", color: "#21366c", marginRight: "14px", width: "35px", height: "35px", padding: "8px" }} />
    },
    {
      route: "Wallet",
      pathname: "/dashboard/wallet",
      icon: <WalletOutlinedIcon sx={{ borderRadius: "50px", backgroundColor: "white", color: "#21366c", marginRight: "14px", width: "35px", height: "35px", padding: "8px" }} />
    },
  ]
