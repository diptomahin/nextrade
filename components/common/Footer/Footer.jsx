      ...
      <Container>
        ...
        <div className=" grid xl:grid-cols-5 lg:grid-cols-3 grid-cols-2 mx-auto gap-8 my-8">
          ...
          <nav className="text-primary-white flex flex-col gap-2">
            ...
            <Link
              href={"/"}
              className="hover:underline duration-200 font-medium text-gray-700 hover:text-black cursor-pointer flex items-center gap-2"
            >
              <InstagramIcon /> <span>4.7M People Like this</span>
            </Link>
            <Link
              href={"/"}
              className="hover:underline duration-200 font-medium text-gray-700 hover:text-black cursor-pointer flex items-center gap-2"
            >
              <FacebookIcon /> <span>1M Followers</span>
            </Link>
