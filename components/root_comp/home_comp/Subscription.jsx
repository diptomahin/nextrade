      ...
      <div className=" py-10">
        ...
        <div className=" grid xl:grid-cols-3 lg:grid-cols-2 grid-cols-1 gap-10 mt-16">
          ...
          <motion.div
            ...
            whileInView={"show"}
            viewport={{ once: false, amount: 0.1 }}
            className=" border border-gray-200  shadow p-6 py-8  rounded-xl "
          >
            <div className="text-center">
            ...
            {/* Cart criteria */}
            <div className=" space-y-5 py-7 h-[380px] px-5">
              {/*criteria 1 */}
              <h3 className=" flex items-center gap-3 text-base font-medium text-gray-500">
            ...
            <div className=" flex items-center justify-center">
              <Button className="w-full lg:h-12">Continue With Basic</Button>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className=" flex items-center justify-center">
              <Button className="w-full lg:h-12">Continue With Standard</Button>
            </div>
          </motion.div>
          {/* cart 1 Premium  plan */}
          <motion.div
          ...
          >
            ...
            <div className=" flex items-center justify-center">
              <Button className="w-full lg:h-12">Continue With Premium</Button>
            </div>
          </motion.div>
        </div>
      </div>
