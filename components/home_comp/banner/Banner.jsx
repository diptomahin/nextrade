...
const Banner = () => {
  return (
    <div className="relative z-10 text-zinc-900 dark:text-zinc-100">
      <div className="banner w-full h-full hidden dark:block absolute left-0 top-0 opacity-20 -z-20"></div>
      <Container className="py-56 z-10">
        ...
        <div className="flex justify-between items-center gap-5 mt-24">
          <div className="flex gap-4 dark:bg-quaternary border dark:border-darkThree p-5 rounded-xl shadow">
            <Image alt="icon" className="w-12 h-12 rounded-full border" />
            <div className="flex flex-col justify-start">
              <h3 className="text-lg font-medium">Bitcoin (btc)</h3>
              <div className="flex items-center gap-5 mt-3">
                <p className="text-xl font-semibold">$360000</p>
                <p>50%</p>
              </div>
            </div>
          </div>
...
//   <div className="banner w-full min-h-full absolute left-0 bottom-0 opacity-20"></div>
