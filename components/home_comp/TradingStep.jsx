    ...
    <Container className="py-20">
      ...
      <div className="grid xl:grid-cols-3 lg:grid-cols-2 grid-cols-1 gap-6 mt-10 text-darkGray">
        ...
        <motion.div
          ...
          className="bg-thirdGreen/70 shadow-xl px-10 py-5 rounded-xl text-white"
        >
        ...
        <motion.div
          ...
          whileInView={"show"}
          viewport={{ once: false, amount: 0.1 }}
          className="bg-primary/70 shadow-xl px-10 py-5 rounded-xl text-white"
        >
          <div className="flex items-center gap-2">
        ...
        <motion.div
          ...
          whileInView={"show"}
          viewport={{ once: false, amount: 0.1 }}
          className="bg-fourthPink/70 shadow-xl px-10 py-5 rounded-xl text-white"
        >
          <div className="flex items-center gap-2">
