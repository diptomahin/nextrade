...
const UsersInfo = ({ singleUser }) => {
    return (
        <div className='text-sm lg:text-base'>
            ...
            <p><span className='font-semibold'>Address: </span>{singleUser.address ? singleUser.address : "N/A"}</p>
            <p><span className='font-semibold'>Phone: </span>{singleUser.phone ? singleUser.phone : "N/A"}</p>
            ...
            {
                singleUser.lastUpdate && <p><span className='font-semibold'>Last update: </span>{singleUser.lastUpdate.day}/{singleUser.lastUpdate.month}/{singleUser.lastUpdate.year}</p>
            }
        </div>
    );
};
