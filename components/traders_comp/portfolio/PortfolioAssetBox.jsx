                    ...
                    <Link key={idx} href={`/dashboard/market/${asset.assetKey}`}>
                        ...
                        >
                          ...
                          {calculateDifference(
                            ...
                            <p className="text-xs">Buying <br/> <span className="text-green-700 font-semibold"> $ {parseFloat(asset.assetBuyingPrice).toFixed(2)}</span></p>
                            </div>
                            <div className='text-xs flex justify-between items-center gap-4'>
                                <p>Investment <br/> <span className="text-green-700 font-semibold">${asset.totalInvestment}</span></p>
                                 
                                <p>Current <br/> <span className="text-green-500 font-semibold">${asset.currentPrice}</span></p>
                            </div>
                        </div>
                    </Link>
                ))
