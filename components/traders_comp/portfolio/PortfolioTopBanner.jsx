...
const PortfolioTopBanner = ({totalBuyingPrice, calculateTotalProfit, usersRemainingBalance, calculateTotalLoss,}) => {
    const [hideAssetAmount, setHideAssetAmount] = useState(false);
    const [hideRemainingBalance, setHideRemainingBalance] = useState(false);
    return (
        <div className="  flex flex-col md:flex-row items-center md:justify-between bg-white p-4 rounded-md gap-12 lg:gap-5 xl:gap-32">
