                    ...
                    <TableBody>
                        {watchlistData.map((asset, idx) => (
                            ...
                            >
                                ...
                                <TableCell>
                                    <p className={` font-semibold text-xs`}>$ {asset.price}</p>
                                </TableCell>
                                <TableCell>
                                    <p className={` font-semibold text-xs ${asset.changePrice < 0 ? "text-red-700" : "text-green-700"}`}>$ {parseFloat(asset.changePrice).toFixed(1)}</p>
                                </TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
