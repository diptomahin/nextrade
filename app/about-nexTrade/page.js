...
const AboutNexTrade = () => {
    return ( <
        ...
        } > About Nextrade < /Typography> <
        Typography variant = "h6"
        gutterBottom maxWidth = {
            700
        }
        marginX = "auto"
        sx = {
        ...
        At nexTrade, we transcend the conventional definition of an online trading platform; we 've created a dynamic and innovative space where traders, investors, and enthusiasts
        ...
        alt = "trade currency" > < /Image> <
        Typography variant = 'h6'
        fontWeight = "bold" > Trade Currencies < /Typography> <
        Typography sx = {
            {
                fontSize: "14px"
            }
        ...
        alt = "investment image" > < /Image> <
        Typography variant = 'h6'
        fontWeight = "bold" > Invest in Shares < /Typography> <
        Typography sx = {
            {
                fontSize: "14px"
            }
        ...
        alt = "crypto image" > < /Image> <
        Typography variant = 'h6'
        fontWeight = "bold" > Cryptocurrency Trading < /Typography> <
        Typography sx = {
            {
                fontSize: "14px"
            }
