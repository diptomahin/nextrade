  ...
  return (
    <div className=" grid md:grid-cols-7 grid-cols-1  md:gap-5">
      ...
      <div className=" col-span-5 ">
        ...
        />
        {/* coin buying list   */}
        <div className="my-5 p-4 bg-white dark:bg-quaternary rounded-xl shadow ">
      ...
      <div className=" col-span-2 ">
        <div className="p-5 bg-white dark:bg-quaternary rounded-xl shadow  mb-5">
          <BuyAndExchange
        ...
        <div className="p-5 bg-white dark:bg-quaternary rounded-xl shadow ">
