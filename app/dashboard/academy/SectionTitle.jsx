...
const SectionTitle = ({ title, btnText, btnUrl }) => {
  ...
  style={{
    ...
    paddingBottom: '2px',
    backgroundImage: 'linear-gradient(white, white)', // Change to white gradient
  ...
  onMouseEnter={(e) => {
    e.target.style.backgroundPosition = '100% 100%'; // OR 'bottom right'
    e.target.style.backgroundSize = '100% 2px';
  }}
  onMouseLeave={(e) => {
    e.target.style.backgroundPosition = '0 100%'; // OR 'bottom left'
