...
const page = () => {
     return (
          <Container className='pt-24 pb-10 '>
               ...
               <Typography className="text-gray-600 py-4" variant="h6" gutterBottom maxWidth={700} marginX="auto" sx={{ textAlign: "center", fontSize: ["16px", "14px", "16px"] }}>Feel free to reach out to us with any inquiries or feedback. Our dedicated team is here to assist you. Use the form below or send us an email with short description.</Typography>
               ...
               <div className='mx-auto 2xl:mx-24 bg-[#e9eef1] rounded-xl'>
                    <form method='POST' action="https://getform.io/f/a699a1b2-f225-434e-b317-1fbbde8e006c" className='flex p-5 md:p-10 space-y-5 flex-col  w-full'>
                         ...
                         <div className="md:flex justify-between gap-10">
                              <div className="md:w-1/2 md:space-y-5">
                                   <div className="flex flex-col">
                                        ...
                                        <input className='bg-white rounded-lg p-2' type="text" placeholder='Name' name='name' id='name' />
                                   </div>

                                   <div className="flex flex-col">
                                        <label for='name' className="font-semibold text-primary text-xl">Phone:</label>
                                        <input className='bg-white rounded-lg p-2' type="number" placeholder='01 xx xxxx xxx' name='name' id='name' />
                                   </div>
                              </div>
                              ...
                              <div className="md:w-1/2 md:space-y-5">
                                   <div className="flex flex-col">
                                        ...
                                        <input className='p-2 bg-white rounded-lg' type="email" placeholder='example@gmail.com' name='email' id='email' />
                                   </div>

                                   <div className="flex flex-col">
                                        <label for='name' className="font-semibold text-primary text-xl">Company:</label>
                                        <input className='bg-white rounded-lg p-2' type="text" placeholder='Microsoft' name='name' id='name' />
                                   </div>
                              </div>
                         </div>
                         ...
                         <div className="flex flex-col">
                              ...
                              <textarea className='bg-white w-full rounded-lg p-2' name="message" rows="5" placeholder='Your Message' id='message'></textarea>
                         </div>
