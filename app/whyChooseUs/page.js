        ...
        <div>
            ...
            <Grid my={5} container spacing={2}>
                <Grid item xs={12} md={4}>
                    <Card sx={{ minHeight: 295, border: "3px solid #1D366F", textAlign: "center", borderRadius: "8px", transition: "1s", cursor: "pointer", "&:hover": { transform: "scale(1.1)", backgroundColor: "#35c07c" } }}>
                        <CardContent>
