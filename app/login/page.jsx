...
const Login = () => {
  return (
    <div className="relative min-h-[100vh] w-full flex flex-col 2xl:flex-row-reverse bg-gradient-to-br from-primary to-[#352786]">
      <Link
        href="/"
        className="text-white font-semibold fixed top-8  3xl:top-10 right-8  3xl:right-10 z-10 "
      >
        <ArrowBackIcon />
        Home
      </Link>
