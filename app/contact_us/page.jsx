...
const page = () => {
  return (
    <Container className="pt-24 pb-10 ">
      ...
      <div className="mt-5 3xl:mx-24 bg-gradient-to-br from-darkOne to-darkTwo border border-darkThree hover:bg-gradient-to-tl text-darkGray md:flex justify-between rounded py-10">
        <div className="flex flex-col md:flex-row justify-between gap-10 py-10">
          <div className=" 2xl:flex p-10 items-center gap-7 shadow-md lg:p-5  rounded-lg ">
          ...
          <div className=" 2xl:flex p-10 items-center text-white gap-7 shadow-md lg:p-5  rounded-lg">
            <div className=" bg-blue-200  rounded-full w-16 h-16  flex justify-center items-center lg:mb-0 mb-3 ">
